...
from benchmarks.mrcr.evaluation.config import TaskSetting
...
def main(args: argparse.Namespace):
    ...
    if args.wandb_project:
        ...
        artifact_name = f"{model_name}-mrcr-eval".replace("/", "_")
        art = wandb.Artifact(
            name=artifact_name,
            type="evaluation",
        ...
        if pred_dir.exists():
            ...
            if jsonl_files:
                artifact_name = f"{model_name}-mrcr-preds".replace("/", "_")
